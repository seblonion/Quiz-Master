...
if (!estConnecte()) {
    $_SESSION['message'] = "Vous devez être connecté pour créer un quiz.";
...
$categories = (new Database())->connect()->query("SELECT * FROM categories")->fetchAll();
$titre_page = "Créer un Quiz";
?>
...
<main class="create-quiz-page">
    <div class="quiz-container">
        <div class="page-header">
            ...
            <p class="page-description">Créez votre propre quiz et partagez vos connaissances avec la communauté</p>
        </div>

        <div class="quiz-form-container">
            <form id="create-quiz-form" action="submit_quiz.php" method="POST" class="quiz-form">
                <div class="form-card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="titre" name="titre" required maxlength="100" placeholder="Donnez un titre accrocheur à votre quiz">
                            <div class="form-hint">Maximum 100 caractères</div>
                        </div>

                        <div class="form-group">
                            <label for="description">Description <span class="required">*</span></label>
                            <textarea id="description" name="description" required rows="4" placeholder="Décrivez brièvement le contenu de votre quiz"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="difficulty-selector">
                                <div class="difficulty-option">
                                    <input type="radio" id="difficulte-1" name="difficulte" value="1" required checked>
                                    <label for="difficulte-1" class="difficulty-label easy">
                                        <span class="difficulty-dot"></span>
                                        <span>Facile</span>
                                    </label>
                                </div>
                                <div class="difficulty-option">
                                    <input type="radio" id="difficulte-2" name="difficulte" value="2">
                                    <label for="difficulte-2" class="difficulty-label medium">
                                        <span class="difficulty-dot"></span>
                                        <span>Moyen</span>
                                    </label>
                                </div>
                                <div class="difficulty-option">
                                    <input type="radio" id="difficulte-3" name="difficulte" value="3">
                                    <label for="difficulte-3" class="difficulty-label hard">
                                        <span class="difficulty-dot"></span>
                                        <span>Difficile</span>
                                    </label>
                                </div>
                        ...
                        <div id="questions-container">
                            <div class="question-block" data-question-index="0">
                                <div class="question-header">
                                    ...
                                    <button type="button" class="btn-icon remove-question" title="Supprimer cette question" disabled>
                                ...
                                <div class="form-group">
                                    <label for="question-0">Texte de la question <span class="required">*</span></label>
                                    <input type="text" id="question-0" name="questions[0][text]" required placeholder="Saisissez votre question">
                                </div>
                                ...
                                <div class="options-container">
                                    ...
                                    <div class="option-block">
                                        ...
                                        <div class="option-correct">
                                            <input type="radio" id="q0-option0" name="questions[0][correct_option]" value="0" required>
                                            <label for="q0-option0" class="radio-label">Correcte</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="option-block">
                                        ...
                                        <div class="option-correct">
                                            <input type="radio" id="q0-option1" name="questions[0][correct_option]" value="1">
                                            <label for="q0-option1" class="radio-label">Correcte</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="option-block">
                                        ...
                                        <div class="option-correct">
                                            <input type="radio" id="q0-option2" name="questions[0][correct_option]" value="2">
                                            <label for="q0-option2" class="radio-label">Correcte</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="option-block">
                                        ...
                                        <div class="option-correct">
                                            <input type="radio" id="q0-option3" name="questions[0][correct_option]" value="3">
                                            <label for="q0-option3" class="radio-label">Correcte</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
.create-quiz-page .difficulty-label.easy .difficulty-dot {
    background-color: var(--easy-color);
}

.create-quiz-page .difficulty-label.medium .difficulty-dot {
    background-color: var(--medium-color);
}

.create-quiz-page .difficulty-label.hard .difficulty-dot {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!hasError) {
            // Ajouter une animation de chargement ou un message
